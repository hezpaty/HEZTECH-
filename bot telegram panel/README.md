...
```
apt update && apt install wget -y && wget https://raw.githubusercontent.com/hezpaty/HEZTECH-/main/bot%20telegram%20panel/xolpanel.sh && chmod +x xolpanel.sh && ./xolpanel.sh
```
